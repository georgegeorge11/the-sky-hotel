export const organigramList = [
  {
    ...
    "subordinates": [
      ...
      },
      {
        ...
        "image": "../assets/Croitoru Iolanda.png",
        "subordinates": [
          {
            "name": "Ionescu Timeea Maria",
            "position": "Angajat departament resurse",
            "image": "../assets/Ionescu Timeea.png"
          }
        ]
      },
      {
        ...
        "position": "Sef IT",
        "image": "../assets/Panfil Florin.png"
      },
      {
        "name": "Stegaru Doinita Mihaela",
        "position": "Sef comerciale",
        "image": "../assets/Stegaru Mihaela.png",
        "subordinates": [
          {
            "name": "Rusu Denisa Gabriela",
            "position": "Angajat departament comerciale",
            "image": "../assets/Rusu Denisa.png"
          },
          {
            "name": "Dima Vivian",
            "position": "Angajat departament comerciale",
            "image": "../assets/Dima Vivian.png"
          }
        ]
      },
      {
        ...
        "image": "../assets/Nistor Denisa.png",
        "subordinates": [
          {
            "name": "Sorcaru Andra Cosmina",
            "position": "Angajat department marketing",
            "image": "../assets/Sorcaru Andra.png"
          },
          {
            "name": "Cocea Tudor",
            "position": "Angajat department marketing",
            "image": "../assets/Cocea Tudor.png"
          }
        ]
      }
    ]
